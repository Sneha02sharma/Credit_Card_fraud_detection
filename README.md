...
> **Note:** This notebook currently loads the dataset from a local path (`C:\Users\Dell\Downloads\creditcard.csv`). To run it yourself, download `creditcard.csv` from Kaggle and update that path in the notebook to match where you've saved it on your machine.
## Acknowledgements
